...
/**
 * check_elf - function that checks to know if file is an
 * ELF file.
...
/**
 * print_magic - function that prints magic numbers of an ELF.
 * @e_ident: an array containing the ELF magic numbers.
 *
 * Return: 0 on success
...
/**
 * print_entry - function that prints entry point of an ELF header.
...
/**
 * main - function that displays information contained in the ELF header
 * at the start of an ELF file.
 * @argc: number of arguments added to the program.
